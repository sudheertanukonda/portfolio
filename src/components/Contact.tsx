...
Message: ${formData.message}
  ...
  return (
    <div className="py-16 bg-gray-900 min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: 'url("https://example.com/your-image.jpg")' }}>
      <div className="max-w-4xl mx-auto bg-gray-800/60 backdrop-blur-lg rounded-2xl p-8 shadow-xl relative">
          ...
          <div className="space-y-8">
            <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  <Linkedin className="text-purple-400 w-6 h-6" /> {/* LinkedIn Icon */}
                  <a 
                  ...
                  >
                    linkedin.com/in/sudheertanukonda
                  </a>
                </div>
              </div>
              ...
              <div className="mt-6">
                <img 
                  src="https://content.tui.co.uk/adamtui/2021_10/6_14/4b834562-efa5-4aa9-ae3d-adb900ec2103/TUISTAFF_HR_RETAIL_F035WebOriginalCompressed.jpg" 
                  alt="Contact Team" 
