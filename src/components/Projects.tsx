  ...
  const projects = [
    {
      ...
      live: "https://github.com/sudheertanukonda/Pober-BI-reports.git",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div 
              key={index} 
              className="group relative bg-gray-800/70 backdrop-blur-lg rounded-3xl overflow-hidden shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-500"
            >
              ...
              <div className="relative p-6">
                ...
                <div className="space-y-4">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors mt-4 text-lg font-semibold"
                  >
