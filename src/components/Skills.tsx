      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {skillCategories.map((category, index) => (
            <div
              key={index}
              className="relative group overflow-hidden rounded-2xl transform transition-all duration-500 hover:scale-105"
              style={{
            ...
            >
              ...
              <div className="absolute inset-0 rounded-2xl bg-pink-500/10 opacity-0 group-hover:opacity-50 transition-all duration-500"></div>
              ...
              <div className="relative p-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {category.skills.map((skill, idx) => (
                    <div
                      key={idx}
                      className="bg-white/10 backdrop-blur-lg px-4 py-3 rounded-xl text-center border border-white/20 hover:border-blue-400/50 hover:bg-blue-500/10 transition-all duration-300 transform hover:scale-110 group"
                    >
